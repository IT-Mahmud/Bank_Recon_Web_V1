...
CREATE TABLE IF NOT EXISTS bft_matched (
    ...
    -- Matched flags for BFT and (optionally) Tally step
    is_matched_bft TINYINT DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS bt_matched (
    ...
    -- If you want, you can add a primary key or index as needed:
